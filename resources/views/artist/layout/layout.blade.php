...
<head>
    ...
    <title>Artist | @yield('title')</title>
                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                            ...
                            <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item"
                                ...
                                <div class="dropdown-divider"></div><a class="dropdown-item"
                                    ...
                                    Logout</a>
                                     <div class="dropdown-divider"></div><a class="dropdown-item"
                                    href="{{route('setting.index')}}"><i class="feather icon-settings"></i>
                                    Setting</a>
                            </div>
                        </li>
                    </ul>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand " href="{{ route('artist.dashboard') }}">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item @if (Route::currentRouteName() == 'artist.dashboard') active @endif"><a href="index.html"><i class="feather icon-home"></i><span class="menu-title"
                            data-i18n="Dashboard">Dashboard</span></a>
                    <ul class="menu-content">
                        <li class="@if (Route::currentRouteName() == 'dashboard') active @endif"><a
                                href="{{ route('artist.dashboard') }}"><i class="feather icon-circle"></i><span
                ...
                <li class="nav-item @if (Route::currentRouteName() == 'product.index') active @endif"><a href="index.html"><i class="feather icon-home"></i><span class="menu-title"
                            data-i18n="Dashboard">Product Management</span></a>
                    <ul class="menu-content">
                        <li class="@if (Route::currentRouteName() == 'product.index') active @endif"><a
                                href="{{ route('product.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="Analytics">List</span></a>
                        </li>

                        <li class="@if (Route::currentRouteName() == 'product.create') active @endif"><a
                                href="{{ route('product.create') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="Analytics">Add</span></a>
                        </li>
                ...
                <li class="nav-item @if (Route::currentRouteName() == 'order.index') active @endif"><a href="index.html"><i class="feather icon-home"></i><span class="menu-title"
                            data-i18n="Dashboard">Order Management</span></a>
                    <ul class="menu-content">
                        <li class="@if (Route::currentRouteName() == 'order.index') active @endif"><a
                                href="{{ route('order.index') }}"><i class="feather icon-circle"></i><span
                                    class="menu-item" data-i18n="Analytics">Ortder List</span></a>
                        </li>
