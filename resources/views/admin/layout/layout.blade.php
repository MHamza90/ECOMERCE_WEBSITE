    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="nav-item @if (Route::currentRouteName() == 'admin.dashboard') active @endif"><a href="index.html"><i class="feather icon-home"></i><span class="menu-title"
                ...
                <li class="nav-item @if (Route::currentRouteName() == 'blog.create' || Route::currentRouteName() == 'blog.index' || Route::currentRouteName() == 'blog.edit' || Route::currentRouteName() == 'blog.show' ) active @endif"><a href="#"><i class="feather icon-user"></i><span class="menu-title"
                            data-i18n="User">Blog Management</span></a>
                    <ul class="menu-content">
                    ...
                    <li class="@if (Route::currentRouteName() == 'setting.index') active @endif"><a
                                href="{{ route('setting.index') }}"><i class="feather icon-settings"></i><span
                                    class="menu-item" data-i18n="View">Setting</span></a>
                        </li>
                </li>
